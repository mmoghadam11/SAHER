...
import EduInfoItems from "../../forms/EduInfoItems";
...
const AddEduInfo = ({
  ...
  const formItems: any[] = EduInfoItems(setValue);
  useEffect(() => {
  ...
  const onSubmit = (data: FormData) => {
    mutate(
      {
        entity: `firm-edu-controller/${!!editeData ? "update" : "save"}`,
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box display={"flex"} textAlign={"center"} alignItems={"center"}>
            ...
            <Typography variant="h6">
              {editeData
                ? `ویرایش اطلاعات آموزشی انتخاب شده`
