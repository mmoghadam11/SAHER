...
import { membershipInfoItems } from "domains/Institute/forms/MembershipInfo";
import { ceoInfoItems } from "domains/Institute/forms/ceoInfoItems ";
import { contactInfoItems } from "domains/Institute/forms/contactInfoItems";
import { financialInfoItems } from "domains/Institute/forms/financialInfoItems";
...
export default function AddMembership(): JSX.Element {
  ...
  const formSteps: FormStep[] = [
    ...
    {
      name: "تحصیلات",
      formItems: EducationFormItems(setValue, {cityOptions,eduCertificate}),
    },
    {
  ...
  const onSubmit = (data: FullInstituteType) => {
    ...
    mutate(
      {
        entity: `membership/${id !== "new" ? "update" : "save"}`,
            ...
            <Grid container spacing={4}>
              ...
              >
                <Grid item display={"flex"}>
                  ...
                  <Typography variant="h5">فرم اطلاعات کارکنان</Typography>
                </Grid>
