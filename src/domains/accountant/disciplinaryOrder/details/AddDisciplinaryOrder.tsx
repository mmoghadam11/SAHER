...
import { DisciplinaryOrderFormItems } from "./DisciplinaryOrderFormItems";
...
const AddDisciplinaryOrder = ({
  ...
  const formItems: any[] = DisciplinaryOrderFormItems(setValue,{workgroupOptions,orderTypeOptions,orderSubjectOptions});
  useEffect(() => {
