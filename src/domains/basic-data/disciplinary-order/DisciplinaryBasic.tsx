...
const DisciplinaryBasic = (props: Props) => {
  const { id } = useParams();
      ...
      {/* <Grid item md={11}>
        <Paper sx={{ width: "100%", p: 5 }}>
          <Grid item container md={12} spacing={2}>
            <Grid item md={12}>
              <Typography variant="h6">اطلاعات پایه احکام انتظامی</Typography>
            </Grid>
            {formItems?.map((item) => (
...
export default DisciplinaryBasic;
